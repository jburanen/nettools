...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-header">
    <a href="index.html" class="logo">
      ...
      <span class="logo-text">SYN</span>
      <span class="logo-accent">TAX</span>
      <span class="logo-bracket">]</span>
    </a>
    <p class="logo-sub">// check your syntax</p>
  </div>
  ...
  <div class="sidebar-meta">
    <a href="https://github.com/jburanen/SYNtax" class="meta-github" target="_blank" rel="noopener">
    ...
    <p class="meta-disclaimer">Got an idea? <a href="https://github.com/jburanen/SYNtax/issues/new?labels=enhancement" class="meta-link" target="_blank" rel="noopener">Submit an issue</a> at Github with the Enhancement label.</p>
    </div>
</aside>`;
